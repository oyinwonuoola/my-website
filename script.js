...
const projectsData = {
    ...
    'certificate-system': {
        ...
        { 
            ...
            placeholder: 'https://www.loom.com/share/e466e4dde28a44b69359aaff91eb3044'
        }
        ],
    ...
    'social-media': {
        ...
        { 
            ...
            placeholder: 'https://youtu.be/rM_fyIEr2Kg'
        }
        ],
                    ...
                    if (item.type === 'image') {
                        ...
                        return `
                            <div class="media-item video" data-index="${index}">
                                <div class="video-container" style="position: relative; background: linear-gradient(135deg, var(--primary-dark), var(--primary-medium)); min-height: 250px; display: flex; align-items: center; justify-content: center; color: white; cursor: pointer;" onclick="window.open('${item.url}', '_blank')">
                                    <div class="video-placeholder" style="text-align: center;">
                                        ...
                                        <div class="play-button" style="margin-top: 20px; display: inline-flex; align-items: center; gap: 10px; padding: 12px 25px; background: rgba(255,255,255,0.2); border-radius: 50px; font-weight: 600;">
                                            <i class="fas fa-external-link-alt"></i> Watch Demo
                                        </div>
                                    </div>
                                </div>
                            </div>
